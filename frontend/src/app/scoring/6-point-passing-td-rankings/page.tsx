...
const config: ScoringResearchConfig = {
  ...
  settings: { format: "dynasty", numQbs: 2, tep: false, numTeams: 12, passingTdPoints: 6, receptionPoints: 0, rbStarters: 2, wrStarters: 3, teStarters: 1, flexSpots: 1, position: "QB" },
