...
const config: ScoringResearchConfig = {
  ...
  definitions: [["Standard baseline", "Zero fantasy points per reception is the neutral scoring reference."], ["Full PPR", "One point per reception is measured as an adjustment from Standard."], ["Unchanged scoring", "Receiving yards still score 0.1 per yard and receiving touchdowns still score six."], ["Relative value", "The model compares each player’s change with replacement at the same position."]],
