...
const config: ScoringResearchConfig = {
  ...
  description: "Half PPR awards 0.5 points per reception. These values show how that middle ground changes dynasty prices relative to the Standard scoring reference.",
  ...
  definitions: [["Half PPR", "Every reception adds 0.5 fantasy points."], ["Standard baseline", "Zero points per reception is the neutral scoring reference."], ["Replacement line", "Each player is compared with a same-position replacement for the selected lineup."], ["Confidence", "Short historical samples reduce the size of the market adjustment."]],
