...
const sections = [
  ...
  ["Analytics storage", "When enabled, PostHog provides product analytics and session replay using browser local storage rather than marketing cookies. Session replay can record page content, clicks, scrolling, and navigation so we can understand how the product is used; text entered into inputs and textareas is masked before replay data is sent. Analytics is configured to honor the browser Do Not Track preference. Future advertising or affiliate integrations will require this policy to be updated before launch."],
