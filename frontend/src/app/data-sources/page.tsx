    ...
    <>
      ...
      <section className="page-wrap grid gap-10 border-t border-[#171c19] py-14 lg:grid-cols-[0.7fr_1.3fr]">
        ...
        <div className="space-y-5 text-sm leading-7 text-[#59605c]">
          <p>The player-comparison collection is a new view over the same current release, not a second ranking feed. Each page joins two reviewed player profiles with the current dynasty Superflex, dynasty 1QB, Superflex TE-premium, and redraft markets, then runs the published scoring engine for the relevant setting.</p>
          <p>Visible production fields come from the licensed profile record. Comparison conclusions are deterministic value-gap statements generated from the displayed numbers. The hand-reviewed matchup manifest contributes only the pairing, decision frame, and explanatory context; it never overwrites market or scoring values.</p>
          <div className="flex flex-wrap gap-3">
            <a href="/player-comparisons" className="border border-[#171c19] bg-[#8bcfff] px-4 py-3 font-mono text-[10px] font-black uppercase tracking-[0.07em]">Browse all comparisons →</a>
            <a href="/methodology" className="border border-[#171c19] bg-white px-4 py-3 font-mono text-[10px] font-black uppercase tracking-[0.07em]">Read comparison rules →</a>
          </div>
        </div>
      </section>
        ...
        <div>
          ...
          <div className="mt-7 grid gap-px border border-[#171c19] bg-[#171c19] md:grid-cols-3">
            ...
            <article className="bg-[#ffb29a] p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-[#3f453f]">The model compares each player with replacement after dedicated starters and FLEX demand are allocated, scales for sample confidence, and caps movement at ±12% in dynasty or ±20% in redraft. Picks and players without usable profiles remain unchanged.</p>
            </article>
          </div>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <a href="/scoring-impact" className="border border-[#171c19] bg-[#dfff4f] px-4 py-3 font-mono text-[10px] font-black uppercase tracking-[0.07em]">Explore scoring impact →</a>
